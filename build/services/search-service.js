...
var SearchService = /** @class */ (function () {
    ...
    ;
    SearchService.prototype.getSearchCompanyPhones = function (search) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    ;
    SearchService.prototype.getSearchCompanyEmails = function (search) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!search) return [3 /*break*/, 2];
                        return [4 /*yield*/, email_model_1.default.find({ email: { $regex: search, $options: "i" } }).limit(5)];
                    case 1: return [2 /*return*/, _a.sent()];
                    case 2: return [2 /*return*/, null];
                }
            });
    ...
    ;
    SearchService.prototype.getCompanyByIDForSearch = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, company_model_1.default.findById(id).populate([
                            {
                                path: "usersID",
                                select: "lastname firstname"
                            },
