...
var ProductController = /** @class */ (function () {
    ...
    ProductController.prototype.addProduct = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, product_service_1.default.addProduct(req.body)];
                    case 1:
                        newProduct = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, product_service_1.default.deleteProductByID(req.params.id)];
                    case 1:
                        product = _a.sent();
                        return [2 /*return*/, res.json(product)];
                    case 2:
