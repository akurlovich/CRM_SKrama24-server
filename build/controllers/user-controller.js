...
var UserController = /** @class */ (function () {
    ...
    UserController.prototype.registration = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var errors, _a, email, password, firstname, lastname, position, isAdmin, userData, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (!errors.isEmpty()) {
                            return [2 /*return*/, next(api_error_1.default.BadRequest('Bad validation!', errors.array()))];
                        }
                        _a = req.body, email = _a.email, password = _a.password, firstname = _a.firstname, lastname = _a.lastname, position = _a.position, isAdmin = _a.isAdmin;
                        return [4 /*yield*/, user_service_1.default.registration(email, password, firstname, lastname, position, isAdmin)];
                    case 1:
                        userData = _b.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        userData = _a.sent();
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, user_service_1.default.refresh(req.headers.authorization)];
                    case 3:
                        userData = _a.sent();
                        _a.label = 4;
                    case 4:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, user_service_1.default.deleteUserByID(req.params.id)];
                    case 1:
                        user = _a.sent();
                        return [2 /*return*/, res.json(user)];
                    case 2:
    ...
    ;
    UserController.prototype.updateIsAdmin = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var user, error_8;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, user_service_1.default.updateIsAdmin(req.params.id, req.body)];
                    case 1:
                        user = _a.sent();
                        return [2 /*return*/, res.json(user)];
                    case 2:
