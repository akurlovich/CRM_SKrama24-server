...
var CommentController = /** @class */ (function () {
    ...
    ;
    CommentController.prototype.getCommentByID = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var comment, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, comment_service_1.default.getCommentByID(req.params.id)];
                    case 1:
                        comment = _a.sent();
    ...
    ;
    CommentController.prototype.getAllComments = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, comment_service_1.default.getAllComments()];
                    case 1:
                        comments = _a.sent();
