...
var PhoneController = /** @class */ (function () {
    ...
    ;
    PhoneController.prototype.getPhoneByID = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var phone, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, phone_service_1.default.getPhoneByID(req.params.id)];
                    case 1:
                        phone = _a.sent();
    ...
    ;
    PhoneController.prototype.getAllPhones = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var phones, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, phone_service_1.default.getAllPhones()];
                    case 1:
                        phones = _a.sent();
                        return [2 /*return*/, res.json(phones)];
                    case 2:
                        error_3 = _a.sent();
                        next(error_3);
                        return [3 /*break*/, 3];
